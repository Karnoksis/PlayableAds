...
namespace KWS
{
    ...
    public partial class KWS_Editor : Editor
    {
        ...
        void ReflectionSettings()
        {
            ...
            if(_settings.UseScreenSpaceReflection || _settings.UsePlanarReflection) _settings.UseAnisotropicReflections = Toggle("Use Anisotropic Reflections", Description.Reflection.UseAnisotropicReflections, _settings.UseAnisotropicReflections, nameof(_settings.UseAnisotropicReflections));
        ...
        void MeshSettings()
        {
            ...
            else _waterSystem.DebugQuadtree = false;
