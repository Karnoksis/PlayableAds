...
namespace KWS
{
    ...
    public partial class WaterSystem : MonoBehaviour
    {
        ...
        internal float SkyLodRelativeToWind => Mathf.Lerp(0.25f, KWS_Settings.Reflection.MaxSkyLodAtFarDistance, Mathf.Pow(NormalizedWind, 0.35f));
...
//#if KWS_DEBUG
        ...
        {
#if KWS_DEBUG
            if (Settings.WaterMeshType == WaterMeshTypeEnum.CustomMesh) Gizmos.DrawWireCube(WorldSpaceBounds.center, WorldSpaceBounds.size);
#endif
...
//#endif
        ...
        void UpdatePerCamera(Camera cam)
        {
            ...
            SetGlobalPlatformSpecificShaderParams();
